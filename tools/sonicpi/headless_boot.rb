...
require 'open3'
require 'monitor'
require_relative "/Applications/Sonic Pi.app/Contents/Resources/app/server/ruby/bin/../lib/sonicpi/osc/osc"
require_relative "/Applications/Sonic Pi.app/Contents/Resources/app/server/ruby/bin/../lib/sonicpi/osc/tcp_osc_client"
require_relative "/Applications/Sonic Pi.app/Contents/Resources/app/server/ruby/bin/../paths"
require_relative "/Applications/Sonic Pi.app/Contents/Resources/app/server/ruby/bin/../lib/sonicpi/promise"
...
module SonicPi
  class HeadlessBoot
    ...
    def boot!
      ...
      @engine_client = OSC::TcpOscClient.new("localhost", sc_port, name: "Headless SuperSonic Conn", connect_timeout: 15)
